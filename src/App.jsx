        ...
        <section id="work" className="work-section">
          ...
          <div className="carousel-wrapper">
            ...
            <Carousel 
              height={332} 
              images={[
                { src: '/imgs/CultivariumScroll.png', alt: 'Cultivarium Scroll', tags: ['AI Tools', 'Scientific Tools'], description: 'AI-powered scientific research tool to accelerate protocol reproducibility.', defaultText: 'Augmented Scientific Protocols', video: '/imgs/EditingScreen.mp4', caseStudyLink: 'https://www.figma.com/deck/q54aPMelNBjtognApVQemv/AliceCook_2025Fulldeck_Public?node-id=32-625&viewport=-1723%2C62%2C0.4&t=2MsOR9EEvAWoj7Bx-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1' },
                ...
                { src: '/imgs/FastPayScroll.png', alt: 'FastPay Scroll', tags: ['Fintech', 'Accessibility'], description: 'Prioritizing accessibility and ease of use for millions of customers as banking becomes increasingly digital.', defaultText: 'Accessibile Payments on Chase.com' },
