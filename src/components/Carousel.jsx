                       ...
                       {item.isPlaceholder || (!item.isImage && !item.src) ? (
                        ...
                        >
                          <img src={item.src} alt={item.alt || ''} loading="lazy" />
                           {/* IMPORTANT: defaultText labels are a critical feature - do not remove!
                               These labels appear at the top of each carousel image and provide
                               important context about each project. See IMPORTANT_FEATURES.md */}
